...
const NewsletterSection = () => {
  ...
  return (
    <section className="bg-[#5d4634] dark:bg-[#d4a017] py-20 px-6 md:px-20 font-serif">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-[#e5ddca] dark:text-[#2d2d2d] text-lg mb-8 max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="flex-1 relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 rounded-lg border-2 border-[#e5ddca] dark:border-[#2d2d2d] focus:border-[#fdf6e3] dark:focus:border-[#1a1a1a] focus:outline-none text-gray-800 dark:text-gray-200 dark:bg-[#2d2d2d]"
                    required
                  />
          ...
          <p className="text-[#e5ddca] dark:text-[#2d2d2d] text-sm mt-4">
