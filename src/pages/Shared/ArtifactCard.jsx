            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                ...
                <Link to={`/artifacts/${_id}`}>
                  <button className="px-6 py-2 text-sm rounded-lg bg-[#5d4634] text-[#fdf6e3] hover:bg-[#4b3727] transition border-0">
                    View Details
                  </button>
                </Link>
              </div>
      ...
      <div className="p-5 font-serif flex flex-col justify-between h-[280px]">
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <div className="flex gap-2">
            ...
            <Link to={`/artifacts/${_id}`}>
              <button className="px-4 py-1.5 text-sm rounded-md bg-[#5d4634] text-[#fdf6e3] hover:bg-[#4b3727] transition border-0">
                View Details
              </button>
            </Link>
          </div>
